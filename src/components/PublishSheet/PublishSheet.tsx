...
const OPTIONS: PublishOption[] = [
  { label: '服务卡片', sub: '我能提供的服务', to: '/post',            icon: Wrench,            color: 'text-primary-600 bg-primary-50' },
  { label: '发需求',   sub: 'AI 智能匹配 · 商家主动联系', inquiry: true,       icon: Megaphone,         color: 'text-orange-600 bg-orange-50' },
