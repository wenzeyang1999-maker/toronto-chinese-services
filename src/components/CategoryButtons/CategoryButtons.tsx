...
const TOP_CATEGORIES: L1Category[] = [
  {
    ...
    subs: [
      ...
      { emoji: '📋', icon: FileText,      label: '报税',    q: '报税', sectionLabel: '专业服务' },
      { emoji: '⚖️', icon: Scale,         label: '律师',    q: '律师' },
      { emoji: '🛂', icon: Globe,         label: '移民签证', q: '移民' },
      { emoji: '🌐', icon: Globe,         label: '翻译口译', q: '翻译' },
      { emoji: '📚', icon: BookOpen,      label: '补课家教', q: '补课' },
      { emoji: '💻', icon: Monitor,       label: 'IT维修',  q: 'IT' },
      { emoji: '💇', icon: Scissors,      label: '美容美发', q: '美发' },
      { emoji: '🪷', icon: Flower2,       label: '中医推拿', q: '中医' },
      { emoji: '📷', icon: Camera,        label: '摄影',    q: '摄影' },
      { emoji: '🛡️', icon: Umbrella,      label: '保险',    q: '保险' },
