...
import {
  ...
  Briefcase, FileText, Scale, Globe, BookOpen,
  Scissors, Flower2, Camera, Monitor, Dog,
  Baby, Umbrella,
} from 'lucide-react'
...
const TOP_CATEGORIES: L1Category[] = [
  {
    ...
    subs: [
      ...
      { emoji: '🌿', icon: Leaf,          label: '园艺除雪', q: '园艺' },
      { emoji: '🔨', icon: Hammer,        label: '装修',    q: '装修' },
      { emoji: '🔧', icon: Wrench,        label: '水电维修', q: '水电维修' },
      { emoji: '👶', icon: Baby,          label: '育儿保姆', q: '保姆', sectionLabel: '家庭服务' },
      { emoji: '🐾', icon: Dog,           label: '宠物',    q: '宠物' },
      { emoji: '🚦', icon: Gauge,         label: '驾驶培训', q: '驾校' },
      // 汽车服务
  ...
  },
  {
    ...
    to: '/search',
    subs: [
      { emoji: '📋', icon: FileText,  label: '报税',    q: '报税' },
      { emoji: '⚖️', icon: Scale,     label: '律师',    q: '律师' },
      { emoji: '🛂', icon: Globe,     label: '移民签证', q: '移民' },
      { emoji: '🌐', icon: Globe,     label: '翻译口译', q: '翻译', sectionLabel: '语言服务' },
      { emoji: '📚', icon: BookOpen,  label: '补课家教', q: '补课', sectionLabel: '教育' },
      { emoji: '💻', icon: Monitor,   label: 'IT维修',  q: 'IT' },
      { emoji: '💇', icon: Scissors,  label: '美容美发', q: '美发', sectionLabel: '美容健康' },
      { emoji: '🪷', icon: Flower2,   label: '中医推拿', q: '中医' },
      { emoji: '🛡️', icon: Umbrella,  label: '保险',    q: '保险', sectionLabel: '金融' },
      { emoji: '📷', icon: Camera,    label: '摄影',    q: '摄影', sectionLabel: '创意' },
    ],
  },
  {
    id: 'secondhand',
