...
import {
  Search, SlidersHorizontal, MapPin, X, Calendar, Clock,
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between gap-2 mb-1">
                <p className={`text-sm font-semibold leading-snug line-clamp-2 ${readSet.has(`event:${ev.id}`) ? 'text-gray-400' : 'text-gray-900'}`}>
                  {ev.title}
                </p>
