...
import {
  ...
  ShieldCheck, Briefcase, Clock, MessageSquare, Bot, BadgeCheck, Crown, Heart, UserCheck,
} from 'lucide-react'
...
export default function Profile() {
  ...
  const VALID_SECTIONS = ['account','verification','membership','services','saves','follows','messages','browse','chat']
